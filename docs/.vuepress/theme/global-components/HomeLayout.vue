  ...
  <div class="home-main-page">
    <div class="cardpage" style="padding-bottom: 40px;">
      <el-card shadow="always" :body-style="{ padding: '0px' }" class="box-card">
        ...
        >
        <div class="nickname">
          <span class="nick">Magic飘</span>
        </div>
        <div style="padding: 16px;" class="motto">
          <span>School never ends!</span>
        </div>
        <el-row class="funct-button" style="padding: 20px;">
          <el-button round @click="openPage('https://github.com/zhaoFirstStep')">Github</el-button>
        </el-row>
      </el-card>
    </div>
    ...
    <hr>
    <div class="footer">
      <p>Copyright © 2019- zhaoFirstStep</p>
    </div>
  </div>
</template>
